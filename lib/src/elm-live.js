...
module.exports = (argv, options) => {
  ...
  qrCode.toFile(qrCodeImage, address, {
    color: {
        // dark: '#2d592d',  // Blue dots
        light: '#aaa', // Transparent background
    },
    margin: 1,
    scale: 3,
    errorCorrectionLevel: 'L' }, function (err, url) {
    console.log(address);
    termImg(qrCodeImage, function(){});
  })
