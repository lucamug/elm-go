...
${chalk.dim('elm-live:')}
  ...
  Hot Reloading swap the Elm code without
  reloading the page, preserving the state of the app.
  ${chalk.bold('Warning')}: Hot Reloading does not replay
  the messages of the app but just save and restore the state.
  This may bring the app to a wrong state. If this happen
  you need to reload the app in the browser manually.
`)
  }
